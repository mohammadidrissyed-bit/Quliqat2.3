...
const WelcomeMessage = ({ onOpenMenu }: { onOpenMenu: () => void }) => (
    <div className="text-center p-8 flex flex-col items-center justify-center h-full animate-fade-in">
        <button onClick={onOpenMenu} aria-label="Open menu to select a course" className="transition-transform duration-300">
            <Logo size="xxxxl" className="logo-glow animate-intro-logo-pulse" />
        </button>
